...
##### Bradley
I contributed by creating the WBS diagram, and added the structure of the Project Plan and the two presentations. I also helped to come up with ideas for the different classes, and helped with Scope as well. Overall, this was obviously a group effort, and we all contributed our own pieces of input for each section of the Project Plan. I also agreed to do the GUI for the game, and will help to come up with game art too. I plan to get myself more familiar with PyGame as well, in order to design a great GUI. 
